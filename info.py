...
# ============================
CACHE_TIME = int(environ.get('CACHE_TIME', 30000))    # Cache time in seconds (default: 5 minutes)
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Worldcup_Backup')  # Support group link (make sure bot is admin)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/WORLDCUP_MOVIE') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Nothing_HackerBot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Worldcup_Backup') # Update channel link for the bot
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>{file_name}</b>📦 <b>Size:</b> <blockquote>{file_size}</blockquote>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "<b>{file_name}</b>📦 <b>Size:</b> <blockquote>{file_size}</blockquote>")
