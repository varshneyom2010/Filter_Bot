...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1004338955151')  # Support group id (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1004338955151")# Channels for force sub (make sure bot is admin)
