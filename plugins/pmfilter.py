...
async def advantage_spoll_choker(bot, query):
    ...
    if files:
        ...
        btn = InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔰Cʟɪᴄᴋ ʜᴇʀᴇ & ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴀᴅᴍɪɴ🔰", url="https://t.meSmartboy_009")]])
    ...
    try:
        ...
        if settings.get('button'):
            ...
            btn.insert(0,
                       [
                           ...
                           InlineKeyboardButton("📝𝗥𝗘𝗤𝗨𝗘𝗦𝗧 𝗛𝗘𝗥𝗘", url="https://t.meFilmy_DuniyaBot"),
                           InlineKeyboardButton("👥 Groups", url="https://t.me/hd_movie_zonee")
                       ],[
                           InlineKeyboardButton("🚀 Share With Friends", switch_inline_query="")
                       ])
        ...
        if imdb:
            ...
            if ULTRA_FAST_MODE:
                ...
                if settings.get('button'):
                    cap = f"<b>{file.file_name}</b>\n\n⚡️ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : <a href='https://t.meFilmy_DuniyaBot'>Filmy Duniya</a>"
                else:
                    cap = f"<b>{file.file_name}</b>\n\n⚡️ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : <a href='https://t.meFilmy_DuniyaBot'>Filmy Duniya</a>"
